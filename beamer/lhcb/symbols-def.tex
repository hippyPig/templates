%%% $Id: lhcb-symbols-def.tex 21804 2012-06-21 18:50:15Z shall $
%%% ======================================================================
...
\newcommand{\babar}{\mbox{\slshape B\kern-0.1em{\small A}\kern-0.1em
		B\kern-0.1em{\small A\kern-0.2em R}}\xspace}
...
\def\inb {\ensuremath{\mbox{\,nb}^{-1}}\xspace}
\def\pb {\ensuremath{\rm \,pb}\xspace}
\def\invpb {\ensuremath{\mbox{\,pb}^{-1}}\xspace}
\def\ipb {\ensuremath{\mbox{\,pb}^{-1}}\xspace}
...
\def\Lambdac    {\ensuremath{\Lambda_\mathrm{c}}}

\def\pdg  { {\sc Pdg} }

\def\BtoDsphi  	{\ensuremath{B^+\rightarrow D_s^+\phi}\;}
\def\BtoDsKstr  {\ensuremath{B^+\rightarrow D_s^+\Kstrbz}\;}
\def\BtoDKstr  {\ensuremath{B^+\rightarrow D^+\Kstrz}\;}
\def\BtoDsstrphi {\decay{\Bu}{D_s^{*+}\Pphi}}
\def\BtoDsDz   {\decay{\Bu}{\Dsp\Dzb}}
\def\BstoJpsiphi{\decay{\Bs}{\jpsi\Pphi}}
\def\BstoDsDs   {\decay{\Bs}{\Dsp\Dsm}}
\def\BstoDsDsstr{\decay{\Bs}{\Dsspm\Dsmp}}
\def\BdtoDsD    {\decay{\Bd}{\Dsp\Dm}}
\def\BstoDsKKstr{\decay{\Bd}{\Dm\Kp\Kstarzb(892)}}
\def\BdtoDKKstr {\decay{\Bs}{\Dsm\Kp\Kstarzb(892)}}
\def\Btotaunu {\decay{B^+}{\tau^+\nu_\tau}}

\def\fix{ {\footnotesize $f$} }
\def\pfix{ \phantom{{\footnotesize $f$}} }
\def\pz{ \phantom{0} }
\def\vs{{\it vs.}\xspace}
\def\wrt{{\it w.r.t.}\xspace}

\def\maybe{
    \includegraphics[width=0.5\textwidth]{dkstar_ss_final}
    \includegraphics[width=0.5\textwidth]{dkstar_os_final}\\
    \includegraphics[width=0.5\textwidth]{dskstar_ss_final}
    \includegraphics[width=0.5\textwidth]{dskstar_os_final}}
